            ...
            <div className="pt-32 pb-20 container mx-auto px-4">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <p className="text-lg leading-relaxed text-muted-foreground mb-12">
                        At The MOST, we believe that beauty is an art form rooted in precision, hygiene, and personalization.
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 my-20">
                    <div className="bg-secondary/20 h-96 w-full relative overflow-hidden rounded-lg">
                        <Image
                            src="/assets/about_interior.png" // Reusing hero ambience or newly generated if quota allowed
                            alt="The MOST Salon Interior"
                            fill
