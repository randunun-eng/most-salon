        ...
        <footer className="bg-foreground text-background py-16 px-4">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 text-center md:text-left">
                ...
                <div className="flex flex-col items-center md:items-start gap-4">
                    <h2 className="font-serif text-3xl font-bold">The MOST</h2>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <p className="text-sm text-secondary/70">Pannipitiya Road, Asiri Mawatha<br />Battaramulla, Sri Lanka</p>
                    <p className="text-sm text-secondary/70">072 231 6131</p>
            ...
            <div className="mt-16 pt-8 border-t border-secondary/10 text-center text-xs opacity-40">
                &copy; {new Date().getFullYear()} The MOST Beauty Salon. All rights reserved.
            </div>
        </footer>
    );
}
