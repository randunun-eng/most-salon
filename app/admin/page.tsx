...
export default function AdminPage() {
    ...
    return (
        <div className="min-h-screen !bg-black !text-white flex flex-col md:flex-row">
            {/* Sidebar */}
            <div className="md:w-64 !bg-neutral-900 border-r !border-neutral-800 flex flex-col h-screen sticky top-0">
                ...
                {view === 'dashboard' && (
                    <div className="max-w-6xl mx-auto">
                        <div className="flex justify-between items-center mb-10">
                            <div>
                                <h2 className="text-3xl font-bold !text-white mb-2">{date.toDateString() === new Date().toDateString() ? 'Today' : date.toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</h2>
                                <p className="text-gray-400">Viewing {selectedDateBookings.length} appointments</p>
                            </div>
                                        ...
                                        {DAYS_OF_WEEK.map((dayName, idx) => {
                                            ...
                                            return (
                                                <div key={idx} className="flex items-center justify-between p-4 px-6 hover:!bg-white/5 transition-colors">
                                                    <span className="font-medium !text-white w-24">{dayName}</span>
